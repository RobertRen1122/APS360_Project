...
from dataset import MTADataset
...
#         print(f'target_boxes: {target_boxes}')
        mean_avg_prec = mean_average_precision(
            pred_boxes, target_boxes, iou_threshold=0.5, box_format="corner"
        )
